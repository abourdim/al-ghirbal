...
(function () {
  ...
  const T = {
    ar: {
      ...
      disclaimerText: 'لستُ عالما في الشريعة. هذا جهد متواضع من أب/أم مسلم(ة). المحتوى مستمد من الكتاب ومن مصادر إسلامية موثوقة. هذا ليس فتوى. للأسئلة الشرعية المعمقة، يُرجى مراجعة أهل العلم.',
      helpTitle: 'مساعدة',
